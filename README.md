...
저는 이전에 부트캠프에서 Java 부터 공부를 하였지만 현재 주력으로 하는 스택은 React입니다.<br/>
Java를 이용하여 주로 알고리즘을 공부를 하여 현재는 Java 사용 비중이 높은 편이지만<br/>
현재 React 라이브러리를 30퍼 이상 사용을 하였으며, 반응형 웹앱 개발이 가능한 수준입니다.<br/>
...
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=BerkleyLim&layout=compact&hide=HTML,CSS,SCSS,PUG)
